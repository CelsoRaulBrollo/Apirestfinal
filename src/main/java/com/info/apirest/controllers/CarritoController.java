...
public class CarritoController {
   ...
   @GetMapping(value = "/usuario/carrito/{id}/{cartId}")
   ...
   @GetMapping(value = "/usuario/carrito/{id}")
   ...
   @PostMapping(value = "/usuario/carrito/{id}", consumes = MediaType.APPLICATION_JSON_VALUE)
   ...
   @PutMapping(value = "/usuario/carrito/{id}/{cartId}")
   ...
   @DeleteMapping(value = "/usuario/carrito/{id}/{cartId}")
   public ResponseEntity<?> deleteCart(@PathVariable("id") Long id, @PathVariable("cartId") Long cartId) {
      Optional<Usuario> usuario = usuarioRepo.findById(id);
      Optional<Carrito> carrito = carritoRepo.findById(cartId);
      if (usuario.isEmpty() || carrito.isEmpty() || !usuario.get().getCarrito().contains(carrito.get())) {
